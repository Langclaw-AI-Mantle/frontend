...
const proofItems = [
  { label: "Mantle chain ID", value: "5000" },
  { label: "Agent identity", value: "ERC-8004 #94" },
  { label: "Decision records", value: "verifiable" },
  { label: "Trading mode", value: "paper-trade only" },
];
...
const pipelineSteps = [
  ...
  },
  {
    ...
    title: "Test strategy",
    text: "Use Strategy Lab to backtest Mantle pair momentum before any real execution path.",
  },
  {
    icon: BadgeCheckIcon,
    title: "Publish proof",
  ...
  return (
    <section className="mx-auto flex max-w-7xl flex-col gap-14 px-4 py-10 md:px-6 md:py-16">
      <div className="grid overflow-hidden rounded-lg border bg-background md:grid-cols-4">
        {proofItems.map((item) => (
          <div className="border-b p-5 md:border-r md:border-b-0" key={item.label}>
