...
const dataSources = [
  ...
  {
    description: "Mantle protocol TVL, yield, and momentum context.",
    name: "DeFiLlama",
    status: "Public",
  },
  {
  ...
  {
    description: "Mantle-scoped smart-money and market research.",
    name: "Surf",
    status: "Premium",
  },
  {
    description: "Smart-money netflow fallback for Mantle analysis.",
    name: "Nansen",
    status: "Premium",
  },
  {
        ...
        <div className="flex flex-col gap-6">
          <div className="flex flex-col gap-4">
            ...
            <div className="flex flex-col gap-3">
              <h2 className="max-w-3xl text-balance font-semibold text-3xl tracking-normal md:text-5xl">
                Mantle data sources stay visible from the first page.
              </h2>
              <p className="max-w-2xl text-muted-foreground leading-7">
                Langclaw combines public market feeds, Strategy Lab rows,
                premium Mantle intelligence, and optional enrichment. Missing
          ...
          <div className="grid gap-3 rounded-lg border bg-muted/30 p-4 text-sm md:grid-cols-3">
            <SourceNote
              ...
              title="Mantle scoped"
              text="Research defaults to chain ID 5000 for product-grade signals."
            />
            <SourceNote
